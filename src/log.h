...
inline void warn(std::string_view fmt, auto&&... a) { log(Level::Warn, fmt, std::forward<decltype(a)>(a)...); }
inline void info(std::string_view fmt, auto&&... a) { log(Level::Info, fmt, std::forward<decltype(a)>(a)...); }
inline void debug(std::string_view fmt, auto&&... a) { log(Level::Debug, fmt, std::forward<decltype(a)>(a)...); }
